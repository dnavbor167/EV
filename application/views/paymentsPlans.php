<div class="plans-container">
    ...
    <article class="plan-card plan-free" aria-label="Plan Free limitado">
    ...
    <article class="plan-card plan-pro" aria-label="Plan Pro">
    ...
    <article class="plan-card plan-premium" aria-label="Plan Premium">
