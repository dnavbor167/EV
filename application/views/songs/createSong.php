<div id="logInMain">
  ...
  <span class="error"><?= form_error('nameSong') ?></span>

  
  <input placeholder="<?= ucfirst($this->lang->line('nameArtist')); ?>" type="text" name="nameArtist" id="nameArtist" class="inputCreateSong"  value="<?= set_value('nameArtist'); ?>">
  ...
  <div id="btnCrtSongContainer">
    <button id="btnCreateSong" class="buttonOrange"><?= $this->lang->line('createSong'); ?></button>
  </div>
