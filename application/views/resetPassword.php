<div id="logInMain">
  ...
  echo form_open('Auth/reset_password/' . $token, $attributes);
  ?>
  <p>
    <?= $this->lang->line('changePassword'); ?>
  </p>

  <div id="recoverPassword">
    <input placeholder="<?= ucfirst($this->lang->line('password')); ?>" type="password" name="newPassword" id="userPassword" class="form-input">    
    <div>
